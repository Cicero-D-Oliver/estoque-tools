...
CREATE TABLE organizacao_membros (
    ...
    ultima_visualizacao_movimentacoes_em TIMESTAMP WITHOUT TIME ZONE,
...
SELECT
    0, 'Organização Legada', TRUE,
    TIMESTAMP '2000-01-01 00:00:00', MIN(id)
FROM usuarios
HAVING COUNT(*) > 0;
...
WHERE organizacao.nome = 'Organização Legada'
  AND organizacao.criada_em = TIMESTAMP '2000-01-01 00:00:00';
