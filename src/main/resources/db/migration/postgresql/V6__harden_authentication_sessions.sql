...
ALTER TABLE usuarios
    ...
    ADD COLUMN login_bloqueado_ate TIMESTAMP,
    ADD COLUMN ultima_falha_login_em TIMESTAMP,
    ADD CONSTRAINT ck_usuarios_token_version_nao_negativo CHECK (token_version >= 0),
    ADD CONSTRAINT ck_usuarios_tentativas_login_nao_negativas CHECK (tentativas_login_falhas >= 0);
...
CREATE TABLE refresh_tokens (
    ...
    CONSTRAINT ck_refresh_tokens_hash_tamanho CHECK (char_length(token_hash) = 64),
...
CREATE TABLE tokens_recuperacao_senha (
    ...
    CONSTRAINT fk_tokens_recuperacao_usuario FOREIGN KEY (usuario_id)
        REFERENCES usuarios (id) ON UPDATE RESTRICT ON DELETE RESTRICT,
    CONSTRAINT ck_tokens_recuperacao_hash_tamanho CHECK (char_length(token_hash) = 64),
