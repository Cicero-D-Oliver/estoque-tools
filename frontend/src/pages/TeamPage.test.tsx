...
describe('gestão operacional da equipe', () => {
  ...
  it('aprova solicitação com perfil operacional e atualiza as duas listas', async () => {
    ...
    expect(dialog).toHaveTextContent('ana@empresa.com')
    expect(dialog).not.toHaveTextContent('Ana Costa')
  ...
  it('altera o perfil de membro ativo', async () => {
    ...
    expect(dialog).toHaveTextContent('joao@empresa.com')
    expect(dialog).not.toHaveTextContent('João Silva')
    expect(dialog).not.toHaveTextContent('poderá administrar')
